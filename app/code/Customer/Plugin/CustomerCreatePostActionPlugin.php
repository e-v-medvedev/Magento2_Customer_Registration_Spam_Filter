...
class CustomerCreatePostActionPlugin {
    ...
    /**
     * Фильтрация получаемых данных при регистрации нового пользователя для отсечки спамовых сообщений,
     * в которых задают адрес почты получателя а в полях имени или фамилии добавляют спамовый текст со ссылками на
     * сайты.
     * В контенте определяется наличие ссылок и длина полей ограничивается 30 символами.
     * 
